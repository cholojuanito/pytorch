...
def script(obj, optimize=None, _frames_up=0, _rcb=None):
    ...
    **Scripting an nn.Module**
    ...
    if inspect.isclass(obj):
        ...
        maybe_already_compiled_fn = _try_get_jit_cached_function(obj)
        # Only return cached compiled function when recursively scripting
        # if and only if profile directed typing is not enabled.
        if maybe_already_compiled_fn and not monkeytype_trace:
